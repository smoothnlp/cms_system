  ...
  return (
    <section className="text-gray-600 body-font py-40 flex justify-center items-center 2xl:h-screen">
      <div className="container flex md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 my-12 md:mx-auto flex flex-col md:items-start md:text-left items-center text-center">
          {title && (
        ...
        <div className="md:w-1/2 mt-4 relative relative-20 lg:pl-24 md:pl-16 lg:mt-0 lg:col-start-1">
          <ImageCards image={image.data} />
        </div>
      </div>
    </section>
  );
